...
<fieldset class="middle" id="{{ $varUUID }}">
    ...
    <fieldset class="middle">
        ...
        <x-ui.interactive-button id="make-word" type="button" class="course-button-mini max-content" fg_color="#43AA8B" bg_color="#245B4A">Add word</x-ui.interactive-button>
    </fieldset>
    ...
    <x-ui.interactive-button type="button" id="submit-btn-word-search" class="course-button-mini" fg-color="#43AA8B" bg-color="#245B4A">Create question</x-ui.interactive-button>
</fieldset>
