...
<fieldset class="middle" id="{{ $varUUID }}">
    ...
    <x-ui.interactive-button type="button" id="submit-btn-multi-choice" class="course-button-mini middle" fg-color="#43AA8B" bg-color="#245B4A">Create question</x-ui.interactive-button>
</fieldset>
