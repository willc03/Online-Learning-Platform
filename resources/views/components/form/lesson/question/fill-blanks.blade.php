...
<fieldset class="middle">
    ...
    <fieldset class="middle">
        ...
        <x-ui.interactive-button id="reset-answers" class="course-button-mini" type="button" fg_color="#D10023" bg_color="#840016">Reset all answers</x-ui.interactive-button>
        <label class="form-flex">
            <span class="required">Add blank fill option:</span>
            <input type="text" name="blank-option-add" />
        </label>
        <x-ui.interactive-button id="add-option" type="button" class="course-button-mini max-content" fg_color="#43AA8B" bg_color="#245B4A">Add option</x-ui.interactive-button>
    </fieldset>
    ...
    <x-ui.interactive-button type="button" id="submit-btn-fill-blanks" class="course-button-mini" fg-color="#43AA8B" bg-color="#245B4A">Create question</x-ui.interactive-button>
</fieldset>

<x-ui.interactive-button id="template" type="button" class="fill-blank-button course-button-mini" fg_color="#81d4fa" bg_color="#5a94af"></x-ui.interactive-button>
