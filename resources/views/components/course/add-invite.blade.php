<form method="post" action="{{ route('course.settings.invite.create', ['id' => $course->id]) }}" id="new-invite-form">
    ...
    <label>
        ...
        <x-ui.checkbox :name="'active'" :checked="true" />
    </label>
    ...
    <fieldset class="middle flex-col">
        ...
        <label>
            ...
            <x-ui.checkbox :name="'unlimitedUses'" />
        </label>
        <label>
    ...
    <fieldset class="middle flex-col">
        ...
        <label>
            ...
            <x-ui.checkbox :name="'neverExpire'" />
        </label>
        <label>
            Set expiry date:
    ...
    <x-ui.interactive-button id="add-invite-btn" class="course-button-mini no-buffer max-content middle" fg_color="#B1CA65" bg_color="#88A236">Submit</x-ui.interactive-button>
