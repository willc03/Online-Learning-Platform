<x-structure.wrapper title="Account">
    ...
    <div class="change-password">
        ...
        <x-ui.interactive-button class="course-button-mini" fg-color="#43AA8B" bg-color="#245B4A" id="password-change-button">Change password</x-ui.interactive-button>
        <form method="post" action="{{ route('account.new-password') }}" class="form-flex" id="change-password">
            ...
            {{-- Submit button --}}
            <x-ui.interactive-button class="course-button-mini middle" fg-color="#43AA8B" bg-color="#245B4A">Submit</x-ui.interactive-button>
    ...
    <div class="delete-account">
        ...
        <form method="post" action="{{ route('account.delete') }}">
            @csrf
            @method('DELETE')
            <x-ui.interactive-button class="course-button-mini max-content" fg_color="#D10023" bg_color="#840016">Delete account</x-ui.interactive-button>
        </form>
    </div>
